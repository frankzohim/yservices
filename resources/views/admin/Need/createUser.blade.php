...
@section('title', __("Creation compte client"))
...
<body>
        <div class="container">
        <form class="form-horizontal" role="form" method="POST" action="{{ route('need.storeUser') }}">
            @csrf
                    ...
                    <div class="form-group has-danger">
                        ...
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <input type="hidden" name="name" class="form-control" id="name"
                                   placeholder="" value="{{ $need->name ?? "none" }}" required autofocus>
                        </div>
                    </div>
                    <div class="form-group has-danger">
                        ...
                        <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <input type="hidden" name="email" class="form-control" id="email"
                                   placeholder="" value="{{ $need->email ?? "none" }}" required autofocus>
                        </div>
                    </div>
                    <p>Vous etes sur le point de créer un compte Intervenant de l'utilisateur {{ $need->name }}</p>
                </div>
                {{--  <div class="col-md-3">
