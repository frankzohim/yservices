...
<section class="py-9">
  <div class="container">
    <div class="row">
      <div class="col-lg-6">
          <h3 class="text-primary mb-0 mt-2"  style="font-weight:700; color:#1b138a">Aide à l’autonomie / Geste du quotidien</h3>
        <div class="p-3 info-horizontal">
          <div class="icon icon-shape rounded-circle  shadow text-center" style="background-color:#1b138a">
            <i class="fas fa-bed opacity-10"></i>
          </div>
          <div class="description ps-3">
            <p class="mb-0">Aide au lever et au coucher</p>
          </div>
        </div>

        <div class="p-3 info-horizontal">
          <div class="icon icon-shape rounded-circle shadow text-center" style="background-color:#1b138a">
            <i class="fas fa-bath opacity-10"></i>
          </div>
          <div class="description ps-3">
            <p class="mb-0">Aide à la toilette, coiffure, maquillage, habillage</p>
          </div>
        </div>
        <div class="p-3 info-horizontal">
          <div class="icon icon-shape rounded-circle  shadow text-center" style="background-color:#1b138a">
          ...
          <div class="description ps-3">
            <p class="mb-0">Aide-ménagère</p>
          </div>
        </div>
      </div>
      <div class="col-lg-6 mt-lg-0 mt-5 ps-lg-0 ps-0">
         <h3 class="text-primary mb-0 mt-2" style="font-weight:700; color:#1b138a">Aide-ménagère</h3>
        <div class="p-3 info-horizontal">
          <div class="icon icon-shape rounded-circle shadow text-center" style="background-color:#1b138a">
            <i class="fas fa-bed opacity-10"></i>
          </div>
          <div class="description ps-3">
            <p class="mb-0">Ménage</p>
          </div>
        </div>
        ...
        <div class="p-3 info-horizontal">
          ...
          <div class="description ps-3">
            <p class="mb-0">Lessive - repassage</p>
          </div>
        </div>
        <div class="p-3 info-horizontal">
          <div class="icon icon-shape rounded-circle  shadow text-center" style="background-color:#1b138a">
          ...
          <div class="description ps-3">
            <p class="mb-0">Entretien du logement </p>
          </div>
        </div>
      </div>
