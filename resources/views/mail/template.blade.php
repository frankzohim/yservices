                            ...
                            <td class="menu" align="right">
                                <ul>
                                    ...
                                    <li style="display: inline-block;text-decoration: unset"><a href="http://youdom-care.com/index.php/services" 
                                      style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;" target="_blank">Nos Services</a>
                                    </li>
                                    <li style="display: inline-block;text-decoration: unset"><a href="http://youdom-care.com/index.php/clients/join-us" 
                                      style="text-transform: capitalize;color:#444;font-size:16px;margin-right:15px;text-decoration: none;" target="_blank">Nous Rejoindre</a></li>
        ...
        <tr>
            <td style="padding: 30px;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0; text-align:center;">
                    <tr>
                        <td>
                            <a href="#" style="font-size:13px">Service d'aide à la personne</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <p style="font-size:13px; margin:0;">2021 - 2022 Copyright by Youdom Care powered by Tech Wise</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
