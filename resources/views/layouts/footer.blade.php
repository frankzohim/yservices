		<footer class="footer">
				<div class="container">
					...
					<div class="padding-top-sm padding-bottom-xs footer__body">
						...
						<a class=" footer__logo" data-inner-link="true" aria-label="Finom" href="index.html">
						...
						<div class="footer__nav-wrap">
							...
							<ul class="footer-nav">
								...
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Accompagnements</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Présence de nuit</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Ménage</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Repas</a></li>
							</ul>

							<ul class="footer-nav">
								<li class="text caps">Entreprise</li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">A Propos</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Communauté</a></li>

								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="clients/franchise">Franchise</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" data-test="footer-nav_promoactions" href="#">Agences</a></li>

							</ul>

							<ul class="footer-nav">
								<li class="text caps">Aide</li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">FAQ</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Contactez-Nous</a></li>
								<li class="text text_md color_grey"><a class="link" data-inner-link="true" href="#">Mentions Légales</a></li>
								<li class="text text_md color_grey"><a href="#" data-target-action="true" class="link" target="_blank" rel="noopener">Aide</a></li>
							</ul>
						</div>
