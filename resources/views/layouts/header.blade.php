						...
						<div class="header__left">
							...
							<nav class="header__nav header-nav">
								<ul class="header-nav__list">
									...
									<li class="dropdown dropdown_hover-drop dropdown_theme_arrow header-nav__item header-nav__dropdown header-nav__dropdown_big" data-test="header_nav__products">
										Nos Services
										<svg class="icon dropdown__arrow"><use href="#arrow-down-alt"></use>
										</svg>
										<div class="dropdown__drop">
										
											<ul class="dropdown__list dropdown__list_top" data-test="dropdown-list__products">
											
												<li class="dropdown__item">
													<a class="link_inherit" data-inner-link="true" data-test="header_nav__business-account" href="#">
														<div class="header-nav__icon header-nav__icon_pink-light">
															<svg class="icon" width="24px" height="24px"><use href="#invoice"></use>
															</svg>
														</div>
												...
												<li class="dropdown__item"><a class="link_inherit" data-test="header_nav__invoicing" href="#"><div class="header-nav__icon header-nav__icon_pink-light"><svg class="icon" width="16px" height="20px"><use href="#invoice_ver2"></use></svg></div><div class="header-nav__info"><span class="header-nav__name">Repas</span></div></a>
												</li>
												
												<li class="dropdown__item"><a class="link_inherit" data-test="header_nav__cards" href="#"><div class="header-nav__icon header-nav__icon_pink-light"><svg class="icon" width="24px" height="24px"><use href="#card"></use></svg></div><div class="header-nav__info"><span class="header-nav__name">Accompagnements</span></div></a>
												</li>
												
												<li class="dropdown__item"><a class="link_inherit" data-test="header_nav__multibanking" href="#"><div class="header-nav__icon header-nav__icon_pink-light"><svg class="icon" width="24px" height="24px"><use href="#match"></use></svg></div><div class="header-nav__info"><span class="header-nav__name">Présence de nuit</span></div></a>
												</li>
											</ul>
											
											<div class="dropdown__drop-arrow">
											</div>
										</div>
									</li>
									
									<li class="header-nav__item"><a class="link_inherit" data-test="header_nav__pricing" href="#">Tarifs</a>
									</li>
									...
									<li class="dropdown dropdown_hover-drop dropdown_theme_arrow header-nav__item header-nav__dropdown" data-test="header_nav__help">
										Aide
										<svg class="icon dropdown__arrow"><use href="#arrow-down-alt"></use></svg>
										<div class="dropdown__drop"><ul class="dropdown__list" data-test="dropdown-list__help">
											<li class="dropdown__item"><a class="link_inherit" data-test="header_nav__faq" href="#"><span class="header-nav__name">FAQ</span></a></li>
											<li class="dropdown__item"><a class="link_inherit" data-test="header_nav__contacts" href="#"><span class="header-nav__name">Nous Contacter</span></a></li>
											</span></a></li></ul><div class="dropdown__drop-arrow"></div>
										</div>
									</li>
