		...
		<br>
		  ...
		  <!-- start footer  -->
        <footer class="footer-dark bg-frank-blue" >
            <div class="footer-top padding-five-tb lg-padding-eight-tb md-padding-50px-tb">
                <div class="container">
                    <div class="row">
                        <!-- start footer column -->
                        <div class="col-12 col-lg-3 col-sm-6 md-margin-40px-bottom xs-margin-25px-bottom">
                            <span class="text-xl  font-bold text-indigo-800" style="
                        ...
                        <!-- start footer column -->
                        <div class="col-12 col-lg-3 col-sm-6 md-margin-40px-bottom xs-margin-25px-bottom">
                            <span class="text-xl  font-bold text-indigo-800" style="white-space: nowrap;">YOUDOM-CARE</span>
                            <ul>                           
                        ...
                        <div class="col-12 col-lg-3 col-sm-6 md-margin-40px-bottom xs-margin-25px-bottom">
                            <span class="text-xl  font-bold text-indigo-800"
							 style="white-space: nowrap;">LIENS RAPIDES</span>
                            <ul>                           
                        ...
                        <div class="col-12 col-lg-3 col-sm-6 xs-margin-25px-bottom" >
                            <span class="text-xl  font-bold text-indigo-800">CONTACT</span>
                            ...
                            <div style="white-space:nowrap;">
								<i class="fa fa-envelope  icon-very-small margin-10px-right text-white"></i><a href="#"> 
								<span class="text" > contact@youdom-care.com</span> </a>
							</div>
                        </div>
                        <!-- end footer column -->
			...
			style="background-color: #fff">
                ...
                <div class="container" > 
                    <div class="row align-items-center">
						...
						sm-margin-20px-bottom" style="margin-top: 20px">
                           <ul class="footer-links">
								<li class="">
									<a href="{{ route('cgu') }}" class=" font-bold text-indigo-800 color-text">
										<span class="color-text"> CGU</span> </a>
								</li>
								<li class="" style="white-space: nowrap">
										<a href="{{ route('confidentialite') }}" 
										class="text-xl  font-bold text-indigo-800 color-text">
										<span class="color-text">Confidentialité</span></a>
								</li>
							</ul>
                        </div>
                        <div class="col-12 col-md-6 text-center last-paragraph-no-margin sm-margin-20px-bottom">
                            <p class="text-xl  font-bold text-indigo-800 color-text">&copy; 2022 Youdom Care  
								</p>
                        </div>
                        <div class="col-12 col-md-3 text-center text-md-end">
                            <div class="social-icon-style-12">
                                <ul class="extra-small-icon light text-xl  font-bold text-indigo-800 color-text">
                                    <li><a class="facebook" href="https://www.facebook.com/youdomc/" target="_blank">
										<span class="color-text"> <i class="fab fa-facebook-f color-text"></i> </span> 
									</a></li>
                                
                                    <li><a class="instagram" href="https://www.instagram.com/_u/youdom_care" target="_blank">
										<i class="fab fa-instagram color-text"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
