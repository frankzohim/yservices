                                    ...
                                    <div class="card-body pb-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12{{ $errors->has('research') ? ' has-danger' : '' }}">
                                                <select name="research" class="form-control form-select{{ $errors->has('research') ? ' is-invalid' : '' }}"
                                                    aria-label="Default select example" id="research" value="{{ old('research')}}">
                                                    <option value="">
                                                        {{ __('Vous êtes')}}
                                                    </option>
                                            ...
                                            <div class="col-md-6{{ $errors->has('name') ? ' has-danger' : '' }}">
                                                <div class="input-group mb-4">
                                                    <input
                                                        ...
                                                        placeholder="{{ __('Name') }}" aria-label="Full Name"
                                            ...
                                            <div class="col-md-12{{ $errors->has('adresse') ? ' has-danger' : '' }}">
                                                <div class="input-group">
                                                    <input type="text"
                                                        ...
                                                        placeholder="{{ __('Adresse') }}" value="{{ old('adresse') }}" name="adresse"
                                                        required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6{{ $errors->has('postal_code') ? ' has-danger' : '' }}">
                                                <div class="input-group mb-4">
                                                    <input
                                                        ...
                                                        placeholder="{{ __('Code postal') }}" aria-label="Full Name" name="postal_code"
                                            ...
                                            <div class="col-md-6 ps-md-2{{ $errors->has('city') ? ' has-danger' : '' }}">
                                                <div class="input-group">
                                                    <input type="text"
                                                        ...
                                                        placeholder="{{ __('ville') }}" value="{{ old('city') }}" name="city"
                                                        required>
                                                </div>
                                            </div>
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12{{ $errors->has('description') ? ' has-danger' : '' }}">
                                            <textarea name="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" id="message"
                                                rows="4" placeholder="{{ __('Parlez-nous de votre projet') }}" value="{{ old('description') }}" required></textarea>
                                        </div>
                                    </div>
                                    <br>
