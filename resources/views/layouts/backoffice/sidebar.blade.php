<div class="app-sidebar sidebar-shadow">
    ...
    <li>
		...
		<li>
		<a href="elements-icons.html.htm">
		<i class="metismenu-icon"></i>Facture
		</a>
		</li>
		<li>
		<a href="elements-badges-labels.html.htm">
		<i class="metismenu-icon"></i>Abscences
		</a>
		</li>
		<li>
		<a href="elements-cards.html.htm">
    ...
    <li>
    <a href="components-notifications.html.htm">
